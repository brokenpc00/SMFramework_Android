...
public class GL {
    ...
    public static int GL_BLEND_EQUATION_RGB     =                       0x8009 ;   /* same as BLEND_EQUATION */
    ...
    public static int GL_TEXTURE_CUBE_MAP_POSITIVE_X =                  0x8515;
    public static int GL_TEXTURE_CUBE_MAP_NEGATIVE_X  =                 0x8516;
    public static int GL_TEXTURE_CUBE_MAP_POSITIVE_Y  =                 0x8517;
    public static int GL_TEXTURE_CUBE_MAP_NEGATIVE_Y  =                 0x8518;
    public static int GL_TEXTURE_CUBE_MAP_POSITIVE_Z  =                 0x8519;
    public static int GL_TEXTURE_CUBE_MAP_NEGATIVE_Z  =                 0x851A;
    ...
    public static int GL_SHADER_COMPILER       =                        0x8DFA;

    /* Shader Binary */
    public static int GL_SHADER_BINARY_FORMATS    =                     0x8DF8;
    public static int GL_NUM_SHADER_BINARY_FORMATS =                    0x8DF9;

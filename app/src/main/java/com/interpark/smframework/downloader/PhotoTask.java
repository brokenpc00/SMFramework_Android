...
import com.interpark.smframework.downloader.PhotoDownloadRunnable.TaskRunnableDownloadMethods;
...
public class PhotoTask implements TaskRunnableDownloadMethods, TaskRunnableDecodeMethods {
    ...
    PhotoTask(IDirector director) {
        _director = director;
        // Create the runnables
        mDownloadRunnable = new PhotoDownloadRunnable(director, this);
            ...
            boolean cacheFlag, int width, int height, int degrees)
    {
        ...
        mImagePath = photoView.getImagePath();
